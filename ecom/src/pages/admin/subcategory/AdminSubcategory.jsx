        ...
        <>
            ...
            <div className="container-fluid py-3 mb-3 ">
                <div className="row">
                    ...
                    <div className="bg-primary text-light text-center p-2">Subcategory <Link to='/admin/subcategory/create' ><i className='fa fa-plus text-light float-end'></i></Link></div>
                        ...
                        <tbody>
                            {
                                SubcategoryStateData.map((item)=>{
                                    return <tr key={item.id}>
                                        ...
                                        <td>
                                            <Link to={`/admin/subcategory/update/${item.id}`} className='btn btn-primary'><i className='fa fa-edit fs-5'></i></Link>
                                        </td>
