                ...
                <div className="row">
                    ...
                    <div className="col-md-9">
                        ...
                        <form onSubmit={postSubmit}>
                            <div className="mb-3">
                                <label >Name</label>
                                <input type="text" name='name' value={data.name} placeholder='Maincategory Name' onChange={getInputData} className={`form-control border-3 ${show && error.name ? 'border-danger' : 'border-primary'}`} />
